...
function setDisplayName() {
    $.prompt({ state0: { html: 'Enter a display name your friends know you as<br /> ' + '<input type=\"text\" id=\"NameInput\" name=\"NameInput\" value=\"\" />', buttons: { Cancel: false, Save: true }, submit: function (v, m, f) {
        if (v) {
