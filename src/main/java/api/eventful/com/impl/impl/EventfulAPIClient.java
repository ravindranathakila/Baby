package api.eventful.com.impl.impl;

import ai.ilikeplaces.util.Loggers;
import api.eventful.com.impl.Client;
 ...
 */
public class EventfulAPIClient implements Client {
    ...
    @Inject
    public EventfulAPIClient(@Named(value = "app_key") final String app_key, @Assisted final String jsonEndpoint) {
