...
public class RBGet {
    ...
    final static public ResourceBundle logMsgs = ResourceBundle.getBundle("ai.baby.rbs.LogMsgs");
    final static public ResourceBundle expMsgs = ResourceBundle.getBundle("ai.baby.rbs.ExceptionMsgs");
    final static public ResourceBundle l33t = ResourceBundle.getBundle("ai.baby.rbs.l33t");
