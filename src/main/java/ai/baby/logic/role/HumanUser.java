package ai.baby.logic.role;

import ai.baby.logic.crud.DB;
import ai.baby.util.*;
import ai.baby.util.cache.SmartCache;
...
public class HumanUser extends AbstractSFBCallbacks implements HumanUserLocal, ManageObservers, Serializable {
    ...
    final static private ResourceBundle config = ResourceBundle.getBundle("ai.baby.rbs.Config");
     ...
     * <p/>
     * Approach Two To Cache: {@link #cacheAndUpdateWith(ai.baby.logic.role.HumanUserLocal.CACHE_KEY, Object)}
     *
     * @param key
     * @param recoverWith
     * @return the cached or recovered value
     * @see {@link #cacheAndUpdateWith(ai.baby.logic.role.HumanUserLocal.CACHE_KEY, Object)}
     */
     ...
     * <p/>
     * Approach One To Cache: {@link #cache(String, ai.baby.util.cache.SmartCache.RecoverWith)}
     * <p/>
     ...
     * @return old value
     *         <p/>
     * @see {@link #cache(String, ai.baby.util.cache.SmartCache.RecoverWith)}
     */
