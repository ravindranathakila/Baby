...
import ai.baby.logic.Listeners.JSCodeToSend;
import ai.baby.logic.Listeners.ListenerAarrr;
import ai.baby.logic.Listeners.ListenerTribes;
import ai.baby.logic.Listeners.widgets.AlbumManager;
...
// -------------------------- ENUMERATIONS --------------------------
    ...
    public enum Page implements PageFace {
        ...
        Subscribe(ai.baby.logic.Listeners.widgets.subscribe.Subscribe.class,
                ai.baby.logic.Listeners.widgets.subscribe.Subscribe.SubscribeIds.values()
        ) {
            @Override
            public String toString() {
                return "DocSubscribe";
        ...
        UserProperty("ai/ilikeplaces/widgets/UserProperty.xhtml",
                ai.baby.logic.Listeners.widgets.UserProperty.UserPropertyWidgetIds.user_property_profile_photo,
                ai.baby.logic.Listeners.widgets.UserProperty.UserPropertyWidgetIds.user_property_name,
                ai.baby.logic.Listeners.widgets.UserProperty.UserPropertyWidgetIds.user_property_widget,
                ai.baby.logic.Listeners.widgets.UserProperty.UserPropertyWidgetIds.user_property_content
        ...
        SignInOn(
                ...
                ai.baby.logic.Listeners.widgets.SignInOn.SignInOnIds.values()
        ) {
            @Override
            public String getURL() {
        ...
        AdaptableSignup(
                ...
                ai.baby.logic.Listeners.widgets.AdaptableSignup.AdaptableSignupIds.values()) {
            @Override
            public String getURL() {
                throw new IllegalAccessError("SORRY! THIS IS A TEMPLATE WITH NO SPECIFIC PAGE OF WHICH YOU WANT THE URL.");
            }
