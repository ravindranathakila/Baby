...
import ai.baby.logic.cdn.CDNProfilePhoto;
...
final public class GenericFileGrabber extends HttpServlet {
    ...
    private static final ResourceBundle logMsgs = PropertyResourceBundle.getBundle("ai.baby.rbs.LogMsgs");
    private static final ResourceBundle exceptionMsgs = PropertyResourceBundle.getBundle("ai.baby.rbs.ExceptionMsgs");
