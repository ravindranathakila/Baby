package ai.ilikeplaces.copy.http.json.impl.impl;

import ai.ilikeplaces.copy.http.json.impl.Client;
 ...
 */
public class SampleAPIClient implements Client {
    ...
    @Inject
    public SampleAPIClient(@Named(value = "api_key") final String api_key, @Assisted final String jsonEndpoint) {
