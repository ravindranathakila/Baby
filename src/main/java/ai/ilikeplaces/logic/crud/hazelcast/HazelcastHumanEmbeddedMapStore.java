...
import ai.ilikeplaces.entities.HumanEmbedded;
 ...
 * Time: 10:40 PM
 */
public class HazelcastHumanEmbeddedMapStore extends AbstractHCMapStore {

    private Class<HumanEmbedded> type = HumanEmbedded.class;
    ;
