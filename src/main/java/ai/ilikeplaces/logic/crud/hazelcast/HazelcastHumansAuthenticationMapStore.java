...
import ai.ilikeplaces.entities.HumansAuthorization;
 ...
 * Time: 10:40 PM
 */
public class HazelcastHumansAuthenticationMapStore extends AbstractHCMapStore {

    private Class<HumansAuthentication> type = HumansAuthentication.class;
    ;
