...
import ai.ilikeplaces.entities.HumansAlbum;
 ...
 * Time: 10:40 PM
 */
public class HazelcastHumansAlbumMapStore extends AbstractHCMapStore {

    private Class<HumansAlbum> type = HumansAlbum.class;
    ;
