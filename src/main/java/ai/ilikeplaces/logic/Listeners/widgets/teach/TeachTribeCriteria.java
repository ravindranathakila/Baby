 ...
 * Time: 8:08 AM
 */
public class TeachTribeCriteria {
// ------------------------------ FIELDS ------------------------------
...
// --------------------------- CONSTRUCTORS ---------------------------
    ...
    public TeachTribeCriteria() {
    }

    public TeachTribeCriteria(final HumanId humanId) {
    ...
    // -------------------------- OTHER METHODS --------------------------
    public TeachTribeCriteria setHumanId(final HumanId humanId) {
